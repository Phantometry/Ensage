...
function Main(tick)
  ...
  if ursamove1 then
    ...
    if Step == 1 and roshan and me:GetDistance2D(roshan) > 343 then
      me:AttackMove(Vector(4282,-1816,100))
      Step = 2
      Sleep(1700)
    elseif Step == 2 then
      ...
      Step = 3
    elseif Step == 3 and roshan and me:GetDistance2D(roshan) < 280 and me:GetDistance2D(Vector(3478,-1969,100)) < 2 then
      me:Attack(Ward[1])
      me:Stop()
      Step = 1
    end
